...
// DJ sprites — tamagotchi with headphones for sundowner event
const SPRITE_DJ_DANCE_1 = [
  "........................",
  "..1..55555555555..1.....",
  "..1.5111........5.1.....",
  "..155111........1551....",
...
class Tamagotchi {
  ...
  _loop() {
    ...
    else if (this.state === 'dj-dance') {
      const speed = 6;
      const phase = Math.floor(this.tick / speed) % 4;
      if (phase === 0) this._drawSprite(SPRITE_DJ_DANCE_1, -0.5);
      else if (phase === 1) this._drawSprite(SPRITE_DJ_DANCE_2, 0);
      else if (phase === 2) this._drawSprite(SPRITE_DJ_DANCE_1, 0.5);
      else this._drawSprite(SPRITE_DJ_DANCE_2, 0);
    }
